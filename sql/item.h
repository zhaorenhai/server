...
static inline int operator~(const item_flags_t a)
{
  return ~ (int) a;
}


static inline item_flags_t operator&(const item_flags_t a, const item_flags_t b)
{
  return (item_flags_t) (((uint8) a) & ((uint8) b));
}

static inline item_flags_t operator&(const item_flags_t a, int b)
{
  return (item_flags_t) (((uint8) a) & b);
}

static inline item_flags_t & operator&=(item_flags_t &a, int b)
{
  a= (item_flags_t) (((uint8) a) & b);
  return a;
}
...
static inline item_flags_t & operator|=(item_flags_t &a, const item_flags_t b)
{
  a= (item_flags_t) (((uint8) a) | ((uint8) b));
  return a;
}



enum class item_with_t : uint8
{
  NONE=             0,
  PARAM=       (1<<0), // If Item contains an SP parameter
...
static inline int operator~(const item_with_t a)
{
  return ~ (int) a;
}

static inline item_with_t & operator&=(item_with_t &a, int b)
{
  a= (item_with_t) (((uint8) a) & b);
  return a;
}

static inline item_with_t operator&(const item_with_t a, int b)
{
  return (item_with_t) (((uint8) a) & b);
}

static inline item_with_t operator&(const item_with_t a, const item_with_t b)
{
  return (item_with_t) (((uint8) a) & ((uint8) b));
}
...
static inline item_with_t & operator|=(item_with_t &a, const item_with_t b)
{
  a= (item_with_t) (((uint8) a) | ((uint8) b));
  return a;
}
...
protected:
  ...
  /* All "with_xxx()" flags are stored here */
  item_with_t with_flags;

  inline void copy_item_flags(const Item *org)
  {
    item_flags= org->item_flags;
  }
  static item_with_t bitor_with_flags(const Item *a, const Item *b)
  {
    return a->with_flags | b->with_flags;
  }
  static item_with_t bitor_with_flags(const Item *a, const Item *b,
                                      const Item *c)
  {
    return a->with_flags | b->with_flags | c->with_flags;
  }
  static item_with_t bitor_with_flags(const Item *a, const Item *b,
                                      const Item *c, const Item *d)
  {
    return a->with_flags | b->with_flags | c->with_flags | d->with_flags;
  }
  static item_with_t bitor_with_flags(const Item *a, const Item *b,
                                      const Item *c, const Item *d,
                                      const Item *e)
...
public:
  ...
  */
  ...
  inline void set_flags(item_flags_t flags) { item_flags= flags; }
  inline bool maybe_null() const { return (bool) (item_flags & item_flags_t::MAYBE_NULL); }
  inline bool in_rollup() const { return (bool) (item_flags & item_flags_t::IN_ROLLUP); }
  inline bool with_param() const
  {
    return (bool) (with_flags & item_with_t::PARAM);
  }
  inline void set_with_param()
  {
    with_flags|= item_with_t::PARAM;
  }
  inline bool with_window_func() const
  {
    return (bool) (with_flags & item_with_t::WINDOW_FUNC);
  }
  inline void set_with_window_func()
  {
  ...
  inline void set_with_field()
  {
    with_flags|= item_with_t::FIELD;
  }
  inline void set_without_field()
  {
    with_flags&= ~item_with_t::FIELD;
  }
  inline void copy_with_flags(const Item *item)
  {
    with_flags= item->with_flags;
  }
  inline void join_with_flags(const Item *item)
  {
    with_flags|= item->with_flags;
  }
  ...
  {
    return (bool) (item_flags & item_flags_t::FIXED);
  }

  inline bool is_autogenerated_name() const
  {
    return (bool) (item_flags & item_flags_t::IS_AUTOGENERATED_NAME);
  }
  inline void set_is_explicit_name()
  {
    item_flags&= ~item_flags_t::IS_AUTOGENERATED_NAME;
  }
  inline bool is_in_with_cycle() const
  {
    return (bool) (item_flags & item_flags_t::IS_IN_WITH_CYCLE);
  }
  inline void set_in_with_cycle()
  {
    item_flags|= item_flags_t::IS_IN_WITH_CYCLE;
  }
  inline bool with_sum_func() const
  {
    return (bool) (with_flags & item_with_t::SUM_FUNC);
  }
  inline void set_with_sum_func()
  {
    with_flags|= item_with_t::SUM_FUNC;
  }
  inline void set_without_sum_func()
  {
    with_flags&= ~item_with_t::SUM_FUNC;
  }
  ...
  inline void set_with_subquery()
  {
    with_flags|= item_with_t::SUBQUERY;
  }
  inline void set_maybe_null_in_rollup()
  {
    item_flags|= item_flags_t::MAYBE_NULL | item_flags_t::IN_ROLLUP;
  }
  ...
  */
  ...
  {
    item_flags|= item_flags_t::MAYBE_NULL;
  }
  ...
  {
    item_flags= (item_flags & ~item_flags_t::MAYBE_NULL) |
                (item->item_flags & item_flags_t::MAYBE_NULL);
  }
  inline void set_maybe_null(bool maybe_null_arg)
  {
    maybe_null_arg ? set_maybe_null() : set_not_null();
  }
...
public:
  ...
  Item_fixed_hybrid(THD *thd, Item_fixed_hybrid *item)
   :Item(thd, item)
  {
    item_flags|= item->item_flags & item_flags_t::FIXED;
  }
...
public:
    ...
    enum_set_typelib(attr->get_typelib())
  {
    ...
    copy_item_flags(item);
    /*
      Replace the "maybe_null" flag set by the above copy_item_flags()
      to the explicitly passed value.
    */
    set_maybe_null(maybe_null_arg);
  }
